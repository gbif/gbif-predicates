...
public class SimplePredicateTest {
  ...
  public void testEquals() {
    SimplePredicate<OccurrenceSearchParameter> ep1 =
  ...
  public void testHashcode() {
    SimplePredicate<OccurrenceSearchParameter> sp1 =
        new EqualsPredicate<>(TEST_KEY, TEST_VALUE, false);
    SimplePredicate<OccurrenceSearchParameter> sp2 =
        new EqualsPredicate<>(TEST_KEY, TEST_VALUE, false);
    SimplePredicate<OccurrenceSearchParameter> sp3 =
        new LessThanPredicate<>(COMP_PARAM, COMP_VALUE);
    SimplePredicate<OccurrenceSearchParameter> sp4 =
        new GreaterThanPredicate<>(COMP_PARAM, COMP_VALUE);
    ...
    assertThrows(
        ...
        () ->
            new LessThanPredicate<>(
                OccurrenceSearchParameter.DATASET_KEY, UUID.randomUUID().toString()));
  }

  @Test
  public void testSimplePredicateConstruction() {
    SimplePredicate<OccurrenceSearchParameter> p =
        new EqualsPredicate<>(TEST_KEY, TEST_VALUE, false);
  ...
  public void testWrongUuidValue() {
    assertThrows(
        ...
        () ->
            new EqualsPredicate<>(
                OccurrenceSearchParameter.DATASET_KEY, "133-4312-443-2-43-32432423-", false));
  }
