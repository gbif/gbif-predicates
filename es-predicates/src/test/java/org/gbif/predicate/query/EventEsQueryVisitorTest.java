...
public class EventEsQueryVisitorTest {
  ...
  public void testGreaterThanEqualsIncludingNull() {
    GreaterThanOrEqualsPredicate<EventSearchParameter> distanceFromCentroidPredicate =
        new GreaterThanOrEqualsPredicate<>(
            EventSearchParameter.DISTANCE_FROM_CENTROID_IN_METERS, "10");
    try {
  ...
  public void testGreaterThanIncludingNull() {
    GreaterThanPredicate<EventSearchParameter> distanceFromCentroidPredicate =
        new GreaterThanPredicate<>(EventSearchParameter.DISTANCE_FROM_CENTROID_IN_METERS, "10");
    try {
      String query = visitor.buildQuery(distanceFromCentroidPredicate);
      assertEquals(
          "{\n"
  ...
  public void testDisjunctionGreaterThanEqualsIncludingNull() {
    ...
    EqualsPredicate<EventSearchParameter> equalsPredicate =
        new EqualsPredicate<>(EventSearchParameter.TAXON_KEY, "6", false);
